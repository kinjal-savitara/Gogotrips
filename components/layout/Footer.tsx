...
import { CALL_URL, EMAIL, EMAIL_URL, PHONE_NUMBER, WHATSAPP_NUMBER, WHATSAPP_URL } from "@/app/constant";
...
export default function Footer() {
 ...
 <footer className="bg-primary text-white relative overflow-hidden z-0 p-4">
      ...
      <div className="absolute inset-0 bg-no-repeat bg-[url('/images/footer-map-bg.png')] bg-cover bg-center -z-10" />

      
      <div className="relative max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-3 gap-6 pt-5">
        ...
        <div className="mt-2">
          ...
          <div className="text-sm mt-3">
            ...
            <p className="font-light mb-2 leading-relaxed">
              Your journey matters, and so does who books it for you.
            </p>

            <p className="font-light leading-relaxed">
              Unpublished fares, real humans, and priority support… that’s the advantage.
            </p>
          </div>
        </div>

        
        <div className="flex flex-col gap-8 md:contents mt-4">

          {/* Middle Section */}
          <div className="mt-4">
            <h3 className="font-bold md:text-lg mb-4">Contact Info</h3>

            <p className="text-sm mb-3"> Address: 8 The Green, Suite B, Dover, Delaware - 19901</p>
...
<li className="flex items-center gap-1">
                <Link
                  ...
                  className="flex items-center gap-1 hover:underline"
                >
                  <CustomIcon name="whatsapp" className="size-4 w-4 h-4" /> 
                  {WHATSAPP_NUMBER}
                </Link>
              </li>
              <li className="flex items-center gap-1">
          ...
          {/*  Right Section*/}
          <div>
            <h3 className="font-bold md:text-lg mb-4">Quick Links</h3>
