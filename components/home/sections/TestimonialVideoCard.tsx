...
type Props = {
  ...
  autoPlayFn:any; // Ref to store autoplay interval
};
...
//   };
// }) 
export default function TestimonialVideoCard({ data,autoPlayFn }: Props) {
  ...
  const togglePlay = () => {
    ...
    if (isPlaying) {
      ...
      autoPlayFn(true); // Resume carousel autoplay
    } else {
     autoPlayFn(false); // Stop carousel autoplay
